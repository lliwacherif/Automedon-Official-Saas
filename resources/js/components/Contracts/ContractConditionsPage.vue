...
// Shared "Conditions Generales de Location" — used by both ContractTemplate (default) and ContractTemplateV2.
// Static legal page, no props.
</script>
